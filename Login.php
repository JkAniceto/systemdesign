    ...
    <?php
        ...
        if(isset($_POST['login'])){
            ...
            if(empty($username) || empty($password)){
                ...
                echo "<script>window.location.replace('dashboard1.php')</script>";
                return;
            }
            //admin block
            if($_POST['username'] === 'admin'){
                ...
                if($valid)
                    ...
                    echo "<SCRIPT>  window.location.replace('dashboard1.php'); alert('incorrect username or password!');</SCRIPT>";
            }
            else{ //user block
                ...
                if(mysqli_num_rows($result) === 1){
                    ...
                    if($valid && $otp == ""){
                        ...
                        echo "<SCRIPT> window.location.replace('dashboard1.php?username=$username');  </SCRIPT>";
                    }
                    else if($valid && $otp != ""){
        ...
        if(isset($_POST['Verify'])){
            ...
            echo  '<script type="text/javascript">alert("Incorrect Otp!"); window.location.replace("dashboard1.php");</script>';
        }
