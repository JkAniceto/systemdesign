...
<html>
    ...
    <body>
        <div class="container text-center">
            ...
            <input id="dateTime" type="datetime-local" class="col-sm-3" name="date" min="<?php echo $todayWithTime;?>" value="<?php echo $todayWithTime;?>"/>
...
document.getElementById("back").onclick = function () {window.location.replace('dashboard1.php'); };
