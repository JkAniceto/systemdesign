...
<html>
    ...
    <div class="container text-center">
        ...
        <button class="btn btn-success col-sm-4" id="back">Back</button>
          <script>document.getElementById("back").onclick = function () {window.location.replace('dashboard1.php'); };</script>
            <div class="col-lg-12">
                <form method="post">
                    </br>
