...
<html>
    ...
    <div class="container text-center">
        ...
        <!-- <button class="btn btn-success col-sm-5" id="feedback">Customer Feedback</button> -->

        <script>020
            document.getElementById("customer").onclick = function () {window.location.replace('dashboard1.php'); };
              // document.getElementById("feedback").onclick = function () {window.location.replace('samplefeedback.php'); };
        </script>
